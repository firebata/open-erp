...
public enum MaterialClassicManageServiceHelper {
    ...
    public void refreshSelect() {
        ...
        SystemBaseInfo.SINGLETONE.pushBom("fabricClassicItems", fabricClassicItems);

        //辅料材质
        List<SelectItem2> accessoriesClassicItems = materialClassicManageService.querySelectList(null);
        SystemBaseInfo.SINGLETONE.pushBom("accessoriesClassicItems", accessoriesClassicItems);

        //包材材质
        List<SelectItem2> pakingClassicItems = materialClassicManageService.querySelectList(null);
        SystemBaseInfo.SINGLETONE.pushBom("pakingClassicItems", pakingClassicItems);
