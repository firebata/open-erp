...
public enum BuildSeqNoHelper {
     ...
     *
     * @param incrementNumberService IncrementNumberService
     */
    public String getFullSeqNo(String kind_name, IncrementNumberService incrementNumberService) {
        return getFullSeqNo(kind_name, incrementNumberService, 0);
    }
     ...
     * @return
     */
    public String getFullSeqNo(String kind_name, IncrementNumberService incrementNumberService, int defaultLength) {
