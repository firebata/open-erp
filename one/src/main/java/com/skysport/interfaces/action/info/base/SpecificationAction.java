...
import com.skysport.interfaces.model.info.material.impl.helper.SpecificationServiceHelper;
...
public class SpecificationAction extends BaseAction<SpecificationInfo> {
    ...
    @ResponseBody
    @SystemControllerLog(description = "编辑纱支密度菜单")
    ...
    @ResponseBody
    @SystemControllerLog(description = "查询纱支密度信息列表")
    public Map<String, Object> search(HttpServletRequest request) {
        // HashMap<String, String> paramMap = convertToMap(params);
        DataTablesInfo dataTablesInfo = convertToDataTableQrInfo(WebConstants.SPECIFICATION_TABLE_COLUMN, request);
        // 总记录数
    ...
    @ResponseBody
    @SystemControllerLog(description = "编辑纱支密度")
    ...
    @ResponseBody
    @SystemControllerLog(description = "新增纱支密度")
    public Map<String, Object> add(SpecificationInfo areaInfo, HttpServletRequest request,
        ...
        //设置ID
        areaInfo.setNatrualkey(BuildSeqNoHelper.SINGLETONE.getNextSeqNo(WebConstants.SPECIFICATION_INFO, currentNo, incrementNumberService));
    ...
    @ResponseBody
    @SystemControllerLog(description = "查询纱支密度信息")
    public SpecificationInfo info(@PathVariable String natrualKey, HttpServletRequest request, HttpServletResponse reareaonse) {
    ...
    public Map<String, Object> querySelectList(HttpServletRequest request) {
        ...
        List<SelectItem2> commonBeans = specificationService.querySelectList(name);
