...
import com.skysport.interfaces.bean.info.MaterialOfMembraneCoatingInfo;
import com.skysport.interfaces.model.info.material.impl.helper.MaterialOfMembraneCoatingServicHelper;
...
public class MaterialOfMembraneCoatingAction extends BaseAction<MaterialOfMembraneCoatingInfo> {
    ...
    public Map<String, Object> search(HttpServletRequest request) {
        ...
        DataTablesInfo dataTablesInfo = convertToDataTableQrInfo(WebConstants.MOMC_TABLE_COLUMN, request);
        // 总记录数
