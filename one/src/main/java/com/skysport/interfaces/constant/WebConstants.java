...
public interface WebConstants extends TableNameConstants {
    ...
    String WATER_PROOF_TABLE_COLUMN_NAME = "water_proof_table_column_name";
    String ANT_MOSQUITOS_TABLE_COLUMN_NAME = "ant_mosquitos_table_column_name";
    ...
    String T_JC_ANT_MOSQUITOS = "t_jc_ant_mosquitos";//防蚊虫
