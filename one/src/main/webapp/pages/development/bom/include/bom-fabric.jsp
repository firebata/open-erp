        ...
        <form id="{{fabricFormId}}" method="post" class="form-horizontal" action="edit">
            <div id="{{fabricAllInfoId}}" class="bom-info modal-body">
                <div id="{{fabricDetailId}}" class="bom-info">
                    ...
                    <div class="form-group">
                        <label class="control-label  col-xs-1" for="{{materialTypeId}}"> 类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别  <a href="javascript:openChildW('<%=path%>/system/material_type/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label" for="{{blcId}}"> 复合/涂层  <a href="javascript:openChildW('<%=path%>/system/material/blc/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label" for="{{yearCode}}"> 年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;份  <a href="javascript:openChildW('<%=path%>/system/year_conf/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                            <select class="col-xs-12" data-style="btn-info" id="{{yearCode}}" name="yearCode"
                                    placeholder="年份">
                            </select>
                        </div>
                        <label class="col-xs-1  control-label" for="{{spId}}"> 供&nbsp;&nbsp;&nbsp;应&nbsp;&nbsp;&nbsp;商  <a href="javascript:openChildW('<%=path%>/system/sp/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-xs-1  control-label" for="{{classicId}}"> 材&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;质  <a href="javascript:openChildW('<%=path%>/system/material_classic/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label" for="{{pantoneIds}}"> 颜&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;色  <a href="javascript:openChildW('<%=path%>/system/pantone/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                            <select class="col-xs-12  col-sm-12 form-control" multiple="multiple" name="pantoneIds"
                                    placeholder="颜色" id="{{pantoneIds}}"></select>
                        </div>
                        <label class="col-xs-1  control-label" for="{{productTypeId}}"> 品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名  <a href="javascript:openChildW('<%=path%>/system/product_type/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label" for="{{specificationId}}"> 纱支密度  <a href="javascript:openChildW('<%=path%>/system/material/specification/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-xs-1 control-label" for="{{dyeId}}"> 染色方式  <a href="javascript:openChildW('<%=path%>/system/material/dye/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label " style="color: red" for="{{isShow}}"> 主&nbsp;&nbsp;面&nbsp;&nbsp;料<a href="javascript:openChildW('<%=path%>/system/product_type/list')" target="_blank">&nbsp;&nbsp;&nbsp;</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label" for="{{finishId}}"> 防&nbsp;&nbsp;泼&nbsp;&nbsp;水  <a href="javascript:openChildW('<%=path%>/system/material/finish/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-xs-1  control-label" for="{{waterProofId}}"> 水&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;压  <a href="javascript:openChildW('<%=path%>/system/function/water_proof/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label" for="{{permeabilityId}}"> 透&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;气  <a href="javascript:openChildW('<%=path%>/system/function/air_permeability/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label" for="{{waterpressureId}}"> 接缝水压  <a href="javascript:openChildW('<%=path%>/system/function/seam_waterpressure/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label" for="{{ultravioletProtectionId}}"> 抗紫外线  <a href="javascript:openChildW('<%=path%>/system/function/ultraviolet_protection/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-xs-1  control-label" for="{{quickDryId}}"> 快&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;干  <a href="javascript:openChildW('<%=path%>/system/function/quick_dry/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label" for="{{oilProofId}}"> 防&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;油  <a href="javascript:openChildW('<%=path%>/system/function/oil_proof/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                    ...
                    <div id="{{compositeDiv}}" class="divcss5">
                        <div id="{{tiemoDiv}}">
                            <div class="form-group">
                                <label class="col-xs-1  control-label" for="{{compositeClassicId}}"> 材&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;质  <a href="javascript:openChildW('<%=path%>/system/material_classic/list')" target="_blank">+</a></label>
                                <div class="col-xs-2">
                                ...
                                <label class="col-xs-1  control-label" for="{{compositePantoneIds}}"> 颜&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;色  <a href="<%=path%>" target="_blank">+</a></label>
                                <div class="col-xs-2">
                                ...
                                <label class="col-xs-1  control-label" for="{{compositeProductTypeId}}"> 品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名  <a href="javascript:openChildW('<%=path%>/system/product_type/list')" target="_blank">+</a></label>
                                <div class="col-xs-2">
                                    <select class="col-xs-12" data-style="btn-info" id="{{compositeProductTypeId}}" name="compositeProductTypeId" placeholder="品名"></select>
                                </div>

                                <label class="col-xs-1  control-label" for="{{compositeSpecificationId}}"> 纱支密度  <a href="javascript:openChildW('<%=path%>/system/material/specification/list')" target="_blank">+</a></label>
                                <div class="col-xs-2">
                            ...
                            <div class="form-group">
                                <label class="col-xs-1 control-label" for="{{compositeDyeId}}"> 染色方式  <a href="javascript:openChildW('<%=path%>/system/material/dye/list')" target="_blank">+</a></label>
                                <div class="col-xs-2">
                        ...
                        <div class="form-group">
                            <label class="col-xs-1  control-label" for="{{momcId}}"> 膜/涂层材质  <a href="javascript:openChildW('<%=path%>/system/material/momc/list')" target="_blank">+</a></label>
                            <div class="col-xs-2">
                            ...
                            <label class="col-xs-1  control-label" for="{{comocId}}"> 膜/涂层颜色  <a href="javascript:openChildW('<%=path%>/system/material/comoc/list')" target="_blank">+</a></label>
                            <div class="col-xs-2">
                            ...
                            <label class="col-xs-1  control-label" for="{{woblcId}}"> 膜/涂层工艺  <a href="javascript:openChildW('<%=path%>/system/material/wblc/list')" target="_blank">+</a></label>
                            <div class="col-xs-2">
                                <select class="col-xs-12" data-style="btn-info" id="{{woblcId}}" name="woblcId"
                                        placeholder="贴膜/涂层工艺">
                                </select>
                            </div>
                            <label class="col-xs-1  control-label" for="{{mtId}}"> 膜&nbsp;&nbsp;厚&nbsp;&nbsp;度  <a href="javascript:openChildW('<%=path%>/system/material/mt/list')" target="_blank">+</a></label>
                            <div class="col-xs-2">
                        ...
                        <div class="form-group">
                            <label class="col-xs-1  control-label" for="{{compositeFinishId}}"> 防&nbsp;&nbsp;泼&nbsp;&nbsp;水  <a href="javascript:openChildW('<%=path%>/system/material/finish/list')" target="_blank">+</a></label>
                            <div class="col-xs-2">
                            ...
                            <label class="col-xs-1  control-label" for="{{compositePermeabilityId}}"> 透&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;气  <a href="javascript:openChildW('<%=path%>/system/function/air_permeability/list')" target="_blank">+</a></label>
                            <div class="col-xs-2">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-xs-1  control-label" for="{{compositeWaterpressureId}}"> 接缝水压  <a href="javascript:openChildW('<%=path%>/system/function/seam_waterpressure/list')" target="_blank">+</a></label>
                            <div class="col-xs-2">
                            ...
                            <label class="col-xs-1  control-label" for="{{compositeUltravioletProtectionId}}">
                            ...
                            <label class="col-xs-1  control-label" for="{{compositeQuickDryId}}"> 快&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;干  <a href="javascript:openChildW('<%=path%>/system/function/quick_dry/list')" target="_blank">+</a></label>
                            <div class="col-xs-2">
                            ...
                            <label class="col-xs-1  control-label" for="{{compositeOilProofId}}"> 防&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;油  <a href="javascript:openChildW('<%=path%>/system/function/oil_proof/list')" target="_blank">+</a></label>
                            <div class="col-xs-2">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-xs-1  control-label" for="{{compositeAntMosquitosId}}"> 防&nbsp;&nbsp;蚊&nbsp;&nbsp;虫  <a href="javascript:openChildW('<%=path%>/system/function/anti_mosquitos/list')" target="_blank">+</a></label>
                            <div class="col-xs-2">
                ...
                <div id="fabricUnitDosage1" class="bom-info">
                    ...
                    <div class="form-group">
                        <label class="col-xs-1  control-label" for="{{unitId}}"> 用量单位  <a href="javascript:openChildW('<%=path%>/system/material/unit/list')" target="_blank">+</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label" for="{{unitAmount}}"> 单位用量 <a href="javascript:openChildW('<%=path%>/system/product_type/list')" target="_blank">&nbsp;</a></label>

                        <div class="col-xs-2">
                            <input type="text" id="{{unitAmount}}" name="unitAmount" placeholder="用量"
                                   class="col-xs-10 col-sm-12"/>
                        </div>
                        <label class="col-xs-1  control-label" for="{{positionIds}}">物料位置 <a href="javascript:openChildW('<%=path%>/system/product_type/list')" target="_blank">&nbsp;</a></label>
                        <div class="col-xs-2">
                        ...
                        <label class="col-xs-1  control-label " style="color: red" for="{{positionIdBl}}"> 所属归类 <a href="javascript:openChildW('<%=path%>/system/product_type/list')" target="_blank">&nbsp;</a></label>
                        <div class="col-xs-2">
                ...
                <div id="fabricSpinfo1" class="bom-info">
                    ...
                    <div class="form-group">
                        <label class="col-xs-1  control-label" for="{{attritionRate}}"> 损&nbsp;&nbsp;耗&nbsp;&nbsp;率 <a href="javascript:openChildW('<%=path%>/system/product_type/list')" target="_blank">&nbsp;</a></label>
                        ...
                        <label class="col-xs-1  control-label" for="{{unitPrice}}" title="用量单位的价格"> 单价(￥) <a href="javascript:openChildW('<%=path%>/system/product_type/list')" target="_blank">&nbsp;</a></label>
                        <div class="col-xs-2">
                            <input type="text" id="{{unitPrice}}" name="unitPrice" placeholder="单价(￥)"
                                   class="col-xs-10 col-sm-12"/>
                        </div>
                        <label class="col-xs-1  control-label" for="{{colorAmount}}" data-toggle="tooltip"
                        ...
                        <label class="col-xs-1  control-label" for="{{colorPrice}}" title="各色单价 = 各色用量 * 单价">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-xs-1  control-label" for="{{totalAmount}}" data-toggle="tooltip"
                        ...
                        <label class="col-xs-1  control-label" for="{{totalPrice}}" title="各色总用量的价格和 = 订单数量 *  各色单价 ">
