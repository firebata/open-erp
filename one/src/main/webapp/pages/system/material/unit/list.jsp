    ...
    <div class="row">
        <div class="col-xs-12">
            <table id="example" class="table table-striped table-bordered table-hover">
                <thead>
                <tr>
                    <th style="text-align: center">物料单位名称</th>
...
<script type="text/javascript" src="<%=path%>/resources/js/interfaces/system/material/unit/material-unit.js?v=<%=version%>"></script>
