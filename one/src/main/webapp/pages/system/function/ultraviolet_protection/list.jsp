...
<div class="page-content">
    ...
    <div class="page-header">
        <h1>
            系统管理
            <small><i class="icon-double-angle-right"></i> 抗紫外线</small>
        </h1>
    </div>
    <!-- PAGE CONTENT BEGINS -->
    <div class="row">
...
<script type="text/javascript" src="<%=path%>/resources/js/interfaces/system/function/water_proof/jcWaterProof.js?v=<%=version%>"></script>
