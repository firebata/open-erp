...
(function () {
    ...
    var mHtml = '<div class="dataTables_length col-xs-2 col-xs-offset-10" id="prodinst_example_length"><label><button type="button" class="btn btn-info btn-sm" onclick="javascript:_mergeList(\'download_productinstruction\')">导出成衣生产指示单</button></label></div>';
    var table;
    $(function () {
